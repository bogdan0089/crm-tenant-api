...
from app.core.exceptions import BaseAppExeptions
...
@app.exception_handler(BaseAppExeptions)
async def app_exceptions_handler(request: Request, exc: BaseAppExeptions):
