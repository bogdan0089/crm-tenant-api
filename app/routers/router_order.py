...
from app.schemas.schemas_order import CreateOrder, ResponseOrder, UpdateOrder, UpdateOrderStatus
...
async def update_order_status(order_id: int, data: UpdateOrderStatus) -> ResponseOrder:
